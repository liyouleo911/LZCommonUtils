...
- (NSString *)encryptStringWithKey:(NSString*)_encryptKey
{
    ...
    size_t movedBytes  = 0;
    void * bufferPtr ;
    _encryptKey = (_encryptKey == nil)? [self get24BitKey:@"111111111111111111111111"]: [self get24BitKey:_encryptKey];
...
- (NSString *)decryptStringWithKey:(NSString*)_encryptKey
{
    ...
    void *  bufferPtr ;
    _encryptKey = (_encryptKey == nil)? [self get24BitKey:@"111111111111111111111111"]: [self get24BitKey:_encryptKey];
    NSData *encryptedStringData = [GTMBase64 decodeData:[self dataUsingEncoding:NSUTF8StringEncoding]];
...
- (NSString *)get24BitKey:(NSString *)keyString
{
    ...
    if (keyString.length > 24){
        ...
        keyString = [keyString stringByAppendingFormat:[NSString stringWithFormat:@"%%0%lud", 24 - keyString.length], 0];
    }
    return keyString;
}
